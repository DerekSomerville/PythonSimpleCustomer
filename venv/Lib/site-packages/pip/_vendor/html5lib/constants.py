...
E = {
    ...
    "unexpected-start-tag-implies-end-tag":
        "Unexpected start tag (%(start_name)s) "
        "implies end tag (%(end_name)s).",
    "unexpected-start-tag-treated-as":
        "Unexpected start tag (%(original_name)s). Treated as %(new_name)s.",
    "deprecated-tag":
        "Unexpected start tag %(name)s. Don't use it!",
    "unexpected-start-tag-ignored":
        "Unexpected start tag %(name)s. Ignored.",
    "expected-one-end-tag-but-got-another":
        "Unexpected end tag (%(got_name)s). "
        "Missing end tag (%(expected_name)s).",
    "end-tag-too-early":
        "End tag (%(name)s) seen too early. Expected other end tag.",
    "end-tag-too-early-named":
        "Unexpected end tag (%(got_name)s). Expected end tag (%(expected_name)s).",
    ...
    "unexpected-end-tag-treated-as":
        "Unexpected end tag (%(original_name)s). Treated as %(new_name)s.",
    "no-end-tag":
    ...
    "unexpected-frameset-in-frameset-innerhtml":
        ...
        "in the frameset phase (inner_html).",
    ...
    "unexpected-end-tag-after-body-innerhtml":
        "Unexpected end tag after body(inner_html)",
...
adjust_svg_attributes = {
    ...
    "contentstyletype": "content_style_type",
    "diffuseconstant": "diffuse_constant",
    "edgemode": "edge_mode",
    "externalresourcesrequired": "external_resources_required",
...
adjust_math_ml_attributes = {"definitionurl": "definition_url"}
...
unadjust_foreign_attributes = {(ns, local): qname for qname, (prefix, local, ns) in
...
ascii_upper2_lower = {ord(c): ord(c.lower()) for c in string.ascii_uppercase}
...
# entities_windows1252 has to be _ordered_ and needs to have an index. It
...
tag_token_types = frozenset([token_types["StartTag"], token_types["EndTag"],
                           token_types["EmptyTag"]])
