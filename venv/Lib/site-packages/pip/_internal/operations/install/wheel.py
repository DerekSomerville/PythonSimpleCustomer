...
def get_console_script_specs(console):
    ...
    #   - Only pip_x.Y and easy_install-X.Y will be generated and installed
    # ENSUREPIP_OPTIONS=install
    #   - pip_x.Y, pip_x, easy_install-X.Y will be generated and installed. Note
    #     that this option is technically if ENSUREPIP_OPTIONS is set and is
    #     not altinstall
    # DEFAULT
    #   - The default behavior is to install pip, pip_x, pip_x.Y, easy_install
...
def install_wheel(
    ...
    # type: (...) -> None
    with ZipFile(wheel_path, allow_zip64=True) as z:
