...
def msvc9_find_vcvarsall(version):
    ...
    str
        vcvarsall.bat path
    """
    vc_base = r'Software\%s_microsoft\DevDiv\VCForPython\%0.1f'
    key = vc_base % ('', version)
    try:
...
class SystemInfo:
    ...
    def find_programdata_vs_vers(self):
        ...
        for name in hashed_names:
            try:
                ...
                vs_path = state['installation_path']
                ...
                vs_versions[self._as_float_version(
                    state['installation_version'])] = vs_path
    ...
    def WindowsSDKExecutablePath(self):
        ...
        fx = 'WinSDK-NetFx%d_tools%s' % (netfxver, arch.replace('\\', '-'))
        ...
        for ver in self.WindowsSdkVersion:
            regpaths += [join(self.ri.windows_sdk, 'v%s_a' % ver, fx)]
